...
function Graph({counter,setCounter,data,setData,BFSFind,setBFSFind,expand,setExpand,song,rootSong,connectedSongs,clicked,clickedSong,setClickedSong}) {
 ...
 useEffect(() => {
  ...
  if(BFSFind == true){
      ...
      if(counter == 1){
        console.log("Second Song Hit");
        const fetchData = async () => {
          console.log("Data: ")
          console.log(data);
          console.log("Curr Song ID: ")
          console.log(clickedSong.nodeID);
      ...
      /*
      if(counter == 2) {
        console.log("Two Songs Hit");
        console.log(data);
        const fetchData = async () => {
          await findBFS(data[0],data[1]);
          // do something with the data
        };
        fetchData();
